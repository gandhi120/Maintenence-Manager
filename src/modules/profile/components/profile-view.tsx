      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-[#18181B] border border-[#3F3F46] rounded-xl p-6">
          <div className="flex flex-col items-center mb-6">
            <div className="relative mb-4">
              <div className="w-20 h-20 rounded-full bg-gradient-to-br from-[#8B5CF6] to-[#6D28D9] flex items-center justify-center">
                <User className="w-10 h-10 text-white" />
              </div>
              <button className="absolute bottom-0 right-0 w-6 h-6 bg-[#8B5CF6] rounded-full flex items-center justify-center border-2 border-[#18181B]">
                <Camera className="w-3 h-3 text-white" />
              </button>
            </div>
            <h2 className="text-xl font-bold text-[#FAFAFA] mb-1">{name}</h2>
            <p className="text-sm text-[#A1A1AA] mb-2">{phone}</p>
            <span className="text-xs bg-[#8B5CF6]/20 text-[#8B5CF6] px-3 py-1 rounded-full">
              {role}
            </span>
          </div>
        </div>
        ...
        <div className="bg-[#18181B] border border-[#3F3F46] rounded-xl overflow-hidden">
          ...
          <div className="flex items-center justify-between p-4 border-b border-[#3F3F46]">
            ...
            <div className="relative w-11 h-6 bg-[#8B5CF6] rounded-full cursor-pointer">
        ...
        <div className="bg-[#18181B] border border-[#3F3F46] rounded-xl overflow-hidden">
          <div className="flex items-center justify-between p-4 border-b border-[#3F3F46]">
            ...
            <button className="text-xs text-[#8B5CF6] hover:underline">+ Add Technician</button>
          </div>
        ...
        <div className="bg-[#18181B] border border-[#3F3F46] rounded-xl overflow-hidden">
          ...
          <button className="w-full flex items-center gap-3 p-4 hover:bg-[#27272A] transition-colors border-b border-[#3F3F46]">
            ...
            <div className="flex-1 text-left">
              ...
              <p className="text-xs text-[#A1A1AA]">1.0.0</p>
            </div>
          </button>
          <button className="w-full flex items-center gap-3 p-4 hover:bg-[#27272A] transition-colors border-b border-[#3F3F46]">
            <Phone className="w-5 h-5 text-[#A1A1AA]" />
